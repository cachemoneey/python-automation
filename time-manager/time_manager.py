...
# Then, select enabled APIs
# Next, search for Google Calendar API and click "Enable"
# In OAuth consent screen ensure user type is setto "External" and then click "Create"
# Then, give your app a name and provide email details and save & continue
# Next, select "Add or remove scopes" and select all APIs related to Google Calendar --> save & continue until you reach dashboard
# Next, select credentials tab and select OAuth Client ID then slect Desktop app and create
# In the popup, click "Download JSON" then rename as "credentials.json and move into this project folder 
# Ensure you have added yourself as a test user
